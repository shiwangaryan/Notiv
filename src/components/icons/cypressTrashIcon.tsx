...
type CypressTrashIconProps =Record<string, never>
  ...
  return (
    ...
    >
      <path
        ...
        className={`dark:fill-[#2B2939] fill-[#D3D3D3] text-xl transition-all group-hover/native:fill-washed-purple-600`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        className={`dark:fill-[#817EB5]  fill-Neutrals/neutrals-7 transition-all group-hover/native:fill-washed-blue-600`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        ...
        className={`dark:fill-[#817EB5]  fill-Neutrals/neutrals-7 transition-all group-hover/native:fill-washed-blue-700`}
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
